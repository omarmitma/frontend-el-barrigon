...
import {DetallePedidoPersonalizado} from '../entitys/detallePedidoPersonalizado';

@Injectable({
  providedIn: 'root'
})
export class DetallePedidoPersonalizadoService {
  url = environment.urlApi + 'DetallePedidoPersonalizados/';
  textCarga = "DetallePedidoPersonalizado ";

  constructor(private httpClient: HttpClient, private textShared:TextShared) {}

  public registro(user:DetallePedidoPersonalizado): Promise<HttpResponse<any>>{
  ...
  public actualizar(user:DetallePedidoPersonalizado): Promise<HttpResponse<any>>{
