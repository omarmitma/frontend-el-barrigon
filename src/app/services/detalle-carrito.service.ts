...
import { DetalleCarrito } from '../entitys/detalleCarrito';
...
export class DetalleCarritoService {
  ...
  public registro(user:DetalleCarrito): Promise<HttpResponse<any>>{
  ...
  public actualizar(user:DetalleCarrito): Promise<HttpResponse<any>>{
